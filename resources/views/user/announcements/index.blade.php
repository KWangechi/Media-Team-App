    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="container-fluid py-4">
            ...
            @if (auth()->user()->unreadNotifications->isEmpty()) <div>
                <!-- <div class="alert alert-info font-mono text-lg w-50" role="alert">
                    <i class="material-icons mx-1 align-middle">mail</i>
                ...
                <div class="text-center mt-6">
                    ...
                    <a class="btn bg-gradient-warning mt-3" href="{{ route('announcement.markAllAsRead') }}">
