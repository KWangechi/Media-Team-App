...
<aside
    class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-2 fixed-start ms-3 bg-gradient-dark"
    id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'admin-duty-roster' ? ' active bg-gradient-primary' : '' }}  "
                    href="{{ route('admin.duty.index', auth()->user()->id) }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'admin-sunday-report' ? ' active bg-gradient-primary' : '' }}  "
                    href="{{ route('user.sunday-report.index', auth()->user()->id) }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'contributions' ? ' active bg-gradient-primary' : '' }}  "
                    href="{{ route('user.leaves.index', auth()->user()->id) }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            @else
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'duty-roster' ? ' active bg-gradient-primary' : '' }}  "
                    href="{{ route('user.duty.index', auth()->id()) }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">event_note</i>
                    </div>
                    <span class="nav-link-text ms-1">Duty Roster</span>
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'sunday-report' ? ' active bg-gradient-primary' : '' }}  "
                    href="{{ route('user.sunday-report.index', auth()->user()->id) }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">description</i>
                    </div>
